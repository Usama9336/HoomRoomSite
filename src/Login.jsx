...
const Login = () => {
  return (
    <div className="bg-[url('./assets/pattern-c.png')] bg-cover sm:bg-none">
          ...
          <div className="bg-[white] flex flex-col space-y-[1rem] py-[2rem] px-[0.1rem] mx-[0.9rem]">
            ...
            <div className="">
              <div className="sm:ml-[0px] ml-[1.5rem]">
                {/* <img src={sign1} alt="" className='w-[60%]' /> */}
              </div>
              <div className="flex flex-col w-[90%] mx-auto sm:mx-[0px] sm:w-[60%] pt-[1rem] space-y-[2rem]">
                ...
                <div className="flex mx-auto gap-[5px] mt-[3rem] items-center text-center font-normal font-sans">
                  <Link to="/signup">
                    <p className="text-[#616161] hover:cursor-pointer hover:text-[black]  text-[12.8px] font-normal">
                      Are you a Newbie?
                    </p>
                  </Link>
                  <p className="text-[black] text-[12.8px] font-bold">
                    {" "}
