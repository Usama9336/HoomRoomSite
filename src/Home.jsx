    ...
    <div id="background">
      <div className="flex justify-between p-[1rem] items-center">
        ...
        <div className="flex gap-[1.3rem] items-center mr-[1rem]">
          <Link to="/login">
            <p className="text-[white] text-[18px] font-sans hover:cursor-pointer hidden sm:block ">
              Login
            </p>
            <p className="text-[#D00000] bg-[white] mr-[-1.5rem] text-[15px] p-[0.4rem] font-sans hover:cursor-pointer border-[4px] rounded-xl sm:hidden">
              Logout
            </p>
          </Link>
          <Link to="/signup">
            <button className="bg-gradient-to-r from-[#83C44C] to-[#149C78] text-[white] px-[2rem] hidden sm:block shadow-xl">
              Sign Up
            </button>
          </Link>
        </div>
      ...
      <div className="flex flex-col items-center space-y-[2rem] sm:py-[7rem] py-[4rem] ">
        <div className="flex flex-col items-center text-[white] space-y-[0.5rem] mx-[0.7rem]">
          <p className="font-sans font-medium text-[18px]">THE BEST WAY TO</p>
        ...
        <div className="bg-[#303441]  py-[1.2rem]  rounded-xl w-[80%]">
          <div className=" sm:flex w-[95%] mx-auto justify-between sm:space-y-[0px] space-y-[1rem]">
            <TextField
              id="outlined-search"
              label="Search "
              type="search"
              className="rounded-xl w-[100%] sm:w-[58%] bg-[white] "
            />
            <Link to="/nextpage">
