...
<p className='font-sans font-bold text-[30px] sm:text-[44px] text-center'>
Compare Prices Of What You Want
    ...
    <Link to="/nextpage">
    <button className='bg-gradient-to-r from-[#83C44C] to-[#149C78] py-[0.9rem] text-[white] mx-[4.4rem] sm:mx-[0px] sm:px-[2.5rem] shadow-xl mt-[1rem] sm:mt-[0px] '>
