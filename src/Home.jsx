      ...
      <div className="flex justify-between p-[1rem] items-center">
        <div className=" flex gap-[0.5rem]">
          ...
          <div className="w-[60%] sm:w-[30%]">
            <img src={logo} alt="" className="w-[60%] sm:w-[100%]" />
          </div>
        </div>
        <div className="w-[60%] flex items-center sm:w-auto mr-[0rem] sm:mr-[3rem]">
          <Link to="/login">
            <p className="text-[#D00000] bg-[white] mr-[-1rem] text-[14px] sm:text-[17px] p-[0.4rem] sm:py-[0.5rem] sm:px-[1.5rem] font-sans hover:cursor-pointer border-[1px] rounded-xl ">
              Log Out
            </p>
          </Link>
        </div>
        ...
        <div className="bg-[#303441]  py-[1.2rem] sm:py-[2rem]  rounded-xl w-[95%] sm:w-[80%]">
          <div className=" sm:flex w-[90%] mx-auto justify-between sm:space-y-[0px] space-y-[1rem]">
            <TextField
              ...
              label="Search "
              type="search"
              className="rounded-xl w-[100%] sm:w-[73%] bg-[white] "
            />
            <Link to="/nextpage">
